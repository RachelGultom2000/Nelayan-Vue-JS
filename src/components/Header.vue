                ...
                <div class="row align-items-center">
                    <div class="col-md-3 col-7">
                        <router-link :to="{name: 'home'}" class="text-decoration-none" data-abc="true">
                            <span class="logo"><img src="@/assets/nelayan.png" style="width:40px;"> NELAYAN </span>
                        </router-link>
                    </div>
                    <div class="col-md-5 d-none d-md-block">
                    
                            <div class="input-group w-100"><input type="text" v-model="keywords"  class="form-control search-form"
                                    style="width:55%;border: 1px solid #ffffff" 
                                    placeholder="Belanja apa hari ini?">
                                <div class="input-group-append">
                                    <button class="btn search-button" @click="search" type="submit"><i class="fa fa-search"></i>
                                    </button>
                                </div>
                            </div>
