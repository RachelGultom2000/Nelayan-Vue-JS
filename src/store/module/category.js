...
const category = {
    ...
    state: {
        ...
        //product in category
        productInCategory: [] // state ini digunakan untuk menyimpan data product berdasarkan kategory
    ...
    mutations: {
        ...
        PRODUCT_IN_CATEGORY(state, products) { // setelah data berhasil di dapatkan melalui API ,maka akan melakukan commit ke dalam mutation bernama PRODUCT_IN_CATEGORY
    ...
    actions: {
        ...
        getProductInCategory({ commit } ,slug) {  // buat action bernama getProductInCategory yang akan menjalankan API ke dalam laravel untuk mendapatkan data product berdasarkan kategori
