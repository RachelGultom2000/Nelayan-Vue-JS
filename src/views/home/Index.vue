...
<div>
    ...
    <div class="container-fluid mb-5 mt-4">
        ...
        <div class="row">
            <div class="col-md-12">
                <h4 class="font-weight-bold"><i class="fa fa-fish"></i> TERBARU</h4>
            ...
            <div v-for="product in products" :key="product.id" class="col-md-3 col-6 mb-3">
                <div class="card h-100 border-0 shadow rounded-md">
                    ...
                    <div class="card-body">
                        ...
                        <router-link :to="{name: 'detail_product', params:{slug: product.slug}}" class="btn btn-success btn-md mt-3 btn-block shadow-md">LIHAT PRODUK</router-link>
                    </div>
                </div>
            </div>
